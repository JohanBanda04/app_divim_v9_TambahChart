    ...
    <div id="mainContent" class="" >
        <form action="<?php echo $link1; ?>/v/f.html" class="col-lg-12 justify-content-center" method="post" >
            <div class="row justify-content-center p-15">
                <h5 class="m-0 font-weight-bold">Kalender Laporan ITK</h5>
                <?php /*echo $link1; */?><!-- <br>
                <?php /*echo $link2; */?> <br>
                --><?php /*echo $link3; */?>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Nama WNA</th>
                        ...
                        <tbody>
                        <?php foreach($itk_data_pdf as $index=>$dt) { ?>
                            <tr>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <?php echo $this->Mcrud->hari_id(explode(' ',$dt['created_at'])[0]); ?> / <?php echo $this->Mcrud->tgl_id(explode(' ',$dt['created_at'])[0], 'full'); ?>
                                </td>
                                <td  style="text-align: center">
                                    <?php echo $dt['nama'] ; ?>
                                </td>
